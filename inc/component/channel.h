...
__declspec_dll List_t* channelSharedData(Channel_t* channel, const Iobuf_t iov[], unsigned int iovcnt, int pktype, List_t* packetlist);
__declspec_dll Channel_t* channelSharedSend(Channel_t* channel, const void* data, unsigned int len, int pktype);
__declspec_dll Channel_t* channelSharedSendv(Channel_t* channel, const Iobuf_t iov[], unsigned int iovcnt, int pktype);
