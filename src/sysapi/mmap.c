...
BOOL memoryDoMapping(MemoryMapping_t* mm, void* va_base, long long offset, size_t nbytes, void** ret_mptr) {
#if defined(_WIN32) || defined(_WIN64)
...
BOOL memoryUndoMapping(MemoryMapping_t* mm, void* mptr, size_t nbytes) {
#if defined(_WIN32) || defined(_WIN64)
