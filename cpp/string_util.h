...
class string {
public:
	static std::string join(const char c, const std::list<std::string>& str) {
		std::string res;
	...
	static std::string join(const char c, const std::string str[], size_t cnt) {
		std::string res;
	...
	static std::string join(const char c, const std::vector<std::string>& str) {
	...
	static std::vector<std::string> split(const char* str, const char* s) {
		std::vector<std::string> res;
