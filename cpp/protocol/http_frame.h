...
public:
	...
	const std::unordered_map<std::string, std::string>& headers(void) const { return m_headers; }
...
private:
	...
	typedef std::unordered_map<std::string, std::string>::iterator header_iter;
	typedef std::unordered_map<std::string, std::string>::const_iterator header_const_iter;
};
}
